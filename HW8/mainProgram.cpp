...
Config readFile() {
    Config config;
    string line;
    ifstream inputFile("C:/Users/Gyan/Downloads/CSOPESY-S11_GROUP-10_Master_Dir-Final_Merged_MCO1/CSOPESY-S11_GROUP-10_Master_Dir-Final_Merged_MCO1/MCO1/config.txt");
