...
class CreatedScreen : public Screen {
    ...
    public:    
        CreatedScreen(const string& name, ScreenManager* manager, int PID, int numInstruction, size_t memoryReq)
            : Screen(name, PID, numInstruction, memoryReq), // Base class constructor
