...
void FCFS_Scheduler::runScheduler(vector<Processs>& processes, vector<CPU>& cores) {
...
vector<Processs>& FCFS_Scheduler::getProcessList()
{
...
//void FCFS_Scheduler::lockMutex(const Process& process)
//{
//    std::cout << "locking processListMutex" << std::endl;
//    std::lock_guard<std::mutex> lock(this->processListMutex);
//    std::cout << "locked processListMutex" << std::endl;
//}

//setter and getters
//void FCFS_Scheduler::set_procecess(vector<Process>& processes) {
//    this->processList = processes;
//}
//
//void FCFS_Scheduler::set_cpuList(vector<CPU_Core>& cpu_cores) {
//    this->cpuList = cpu_cores;
//}
