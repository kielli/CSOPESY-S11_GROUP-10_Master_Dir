...
void ScreenManager::createScreen(const string& screenName) {
    ...
    if (screenMap.find(screenName) == screenMap.end()) {
        screens.push_back(make_unique<CreatedScreen>(screenName, this, ptrNumber, this->getMaxInstructions(), this->getprocessMem()));  // pass the ScreenManager pointer to CreatedScreen
...
void ScreenManager::createDummyScreen(const string& screenName, const int instructionCount) {
    ...
    if (screenMap.find(screenName) == screenMap.end()) {
        screens.push_back(make_unique<CreatedScreen>(screenName, this, ptrNumber, instructionCount, this->getprocessMem()));  // pass the ScreenManager pointer to CreatedScreen
...
size_t ScreenManager::getprocessMem() {
    return this->processMem;
}
size_t ScreenManager::gettotalMem() {
    return this->totalMem;
}

size_t ScreenManager::getframeMem() {
    return this->frameMem;
}
