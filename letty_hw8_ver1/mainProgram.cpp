...
struct Config {
    ...
    void setMaxOverallMem(const string& value) {
        maxOverallMem = static_cast<size_t>(stoi(value));
    }

    void setMemPerFrame(const string& value) {
        memPerFrame = static_cast<size_t>(stoi(value));

    }

    void setMemPerProc(const string& value) {
        memPerProc = static_cast<size_t>(stoi(value));
    }
};
...
const vector<configEntries> configMap = {
    ...
    {"max-overall-mem",& Config::setMaxOverallMem},
    {"mem-per-frame", &Config::setMemPerFrame},
    {"mem-per-proc", &Config::setMemPerProc}
};
...
string printConfig(const Config& config) {
    ...
    ss << "Number of CPU: " << config.numCPU
        ...
        << "\nMax Overall Memory: " << config.maxOverallMem
        << "\nMemory per Frame: " << config.memPerFrame
        << "\nMemory Per process: " << config.memPerProc
        << "\n=====================================================" << endl;
    return ss.str();
}
