...
int main() {
    ...
    auto& schedulerRound = screenManager.getScheduler2();
        ...
        if (command != "initialize" && screenManager.getInitializeState() == false) {
            ...
            if (command == "scheduler -test") {
                ...
                if (config.scheduler == "FCFS") {
                    ...
                    schedulerThread = thread([&schedulerRound, &processList, &cpuList]() {
                        schedulerRound.runScheduler(processList, cpuList);
                        });
                }
