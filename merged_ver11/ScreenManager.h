...
public:
    ...
    void getCurrentProgress(ScreenManager& manager, const std::vector<CPU>& cpu, int pID);
    /*void getCurrentProgress(ScreenManager& manager, int pID);*/
